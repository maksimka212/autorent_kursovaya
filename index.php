					...
					<div class="content">
						<div id="owl-slide" class="owl-carousel">
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="#">Быстрая аренда автомобиля</a></p>
							...
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="#">Большой выбор на любой вкус</a></p>
							...
							<div class="item">
								...
								<div class="carousel-caption">
									<div class="carousel-caption-inner">
										<p class="carousel-caption-title"><a href="#">Получите наслаждение от поездки</a></p>
								...
								<form role="form" id="contactForm" data-toggle="validator">
									<div class="row">
										<div class="column sm-1-3">
											<div class="wrap-col">
												<input type="text" name="name" id="name" placeholder="Email" required="required" />
